...
set "MAVEN_CMD_LINE_ARGS=compile package"
...
set "MVN=%MVN_HOME%\mvn.cmd"
set "EXECUTABLE=%CATALINA_HOME%\bin\catalina.bat"
set "STARTUP=%CATALINA_HOME%\bin\startup.bat"
set "LOG=%CATALINA_HOME%\logs\catalina.2018-07-19.log"
...
echo =======================================
copy "C:\DEV\projects\estrutura-art-web-maven-version\target\estrutura-art-web-maven-version.war" "C:\Program Files\Apache Software Foundation\Tomcat 8.5\webapps\estrutura-art-web-maven-version.war"
echo =
...
echo =======================================
@rem xcopy /S /E /Y "C:\DEV\projects\estrutura-art-web-maven-version\target\estrutura-art-web-maven-version\*.*" "C:\Program Files\Apache Software Foundation\Tomcat 8.5\webapps\estrutura-art-web-maven-version"
echo =

@REM call "%EXECUTABLE%" run -security
call "%STARTUP%" start
@REM start "Get-Content %LOG% -wait"

echo =
echo =======================================
echo PRONTO! SO DAR F5 na TELA
echo =======================================
echo =
