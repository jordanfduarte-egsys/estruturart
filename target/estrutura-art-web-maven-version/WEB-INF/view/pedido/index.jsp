...
<div class="content p-4">
   <h2>Pedidos</h2>
    ...
    <form class="card mb-4 p-3 js-toggle-avancada hide <c:if test="${isFiltroAvancado}">show</c:if> js-form-avancado" method="POST"  action="${source}pedido">
        ...
        <div class="form-row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <select name="status_id" id="status_id" class="form-control">
                    ...
                    <c:forEach items="${status}" var="iterator">
                        <option value="${iterator.getId()}" <c:if test="${filter.getParam('status_id') == iterator.getId()}">selected</c:if>>${iterator.getNome()}</option>
                    </c:forEach>
                </select>
            </div>

            <div class="col-md-3 mb-3">
                <label for="inlineFormInputName4">CEP ou Endereço</label>
            ...
            <div class="col-md-3 mb-3">
                <label for="inlineFormInputName5">Instalação a partir de</label>
                <input type="text" data-toggle="datepicker" class="form-control mr-sm-2" id="inlineFormInputName5" name="data_ini" placeholder="dd/MM/yyyy" value="${filter.getParam('data_ini')}">
            </div>
        </div>
        <div class="form-row">
            <div class="col-md-3 mb-3">
