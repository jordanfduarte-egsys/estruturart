...
echo =======================================
xcopy /S /E /Y "C:\DEV\projects\estrutura-art-web-maven-version\target\estrutura-art-web-maven-version\*.*" "C:\Program Files\Apache Software Foundation\Tomcat 8.5\webapps\estrutura-art-web-maven-version"
echo =
